    ...
    <section className="py-6 sm:py-12 bg-[#1A1A1A] text-gray-100">
      <div className="container p-6 mx-auto space-y-8">
        <div className="space-y-2">
          <h2 className="text-3xl font-bold">All List Token For Sale</h2>
        ...
        <div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <SingleCard index={5} name={"TRON"} walletAddress={address}/>
          <SingleCard index={6} name={"Uniswap"} walletAddress={address}/>
          <SingleCard index={7} name={"SHIBA INU"} walletAddress={address}/>
          {/* <SingleCard index={8} name={"Matic Token"} walletAddress={address}/> */}
        </div>
      </div>
    </section>
  );
